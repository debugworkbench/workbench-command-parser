...
/**
 * CommandHelp is generated by the `help` command and is used
 * so that it can be rendered in application specific ways according
 * to how the application handles output.
 */
export interface CommandHelp {
  title: string;
  help: string;
  subcommands: Array<SubcommandHelp>;
